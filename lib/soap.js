...
function WSSecurity(username, password, passwordType, _options) {
    var options = _options || {};
    this._username = username;
    this._password = password;
    this._passwordType = passwordType || 'PasswordText';
    this._useTimestamp = (options.useTimestamp !== undefined) ? options.useTimestamp : true;
}
...
WSSecurity.prototype.toXML = function() {
    ...
    console.log(this._useTimestamp);

    // handle timestamp
    var timestamp = this._useTimestamp ?
